    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('ADMIN', 'Administrator')], db_index=True, default='CUSTOMER', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('LOGIN', 'Login'), ('REGISTER', 'Registration'), ('VERIFY', 'Verification')], default='LOGIN', max_length=15)),
